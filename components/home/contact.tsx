...
export default function Contact({ contact }: { contact?: ContactData | null }) {
  ...
  const hours: WorkHour[] =
    contact?.hours && contact.hours.length > 0 ? contact.hours : FALLBACK_HOURS;

  return (
    <section id="contact" className="py-20 md:py-35 w-full">
      <div className="max-w-380 mx-auto px-4 md:px-15">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-10 items-center">
          {/* Map */}
          <div
            className="w-full md:w-1/2 h-72 md:h-120 rounded-[20px] overflow-hidden shrink-0 bg-[#f3f0f7] flex items-center justify-center"
            data-aos="fade-up"
            suppressHydrationWarning
          >
          ...
          <div className="flex flex-col gap-8 flex-1">
            {/* Phones + Social */}
            <div
              className="flex flex-col sm:flex-row gap-6 sm:gap-5 items-start"
              data-aos="fade-up"
              data-aos-delay="100"
              suppressHydrationWarning
            >
                  ...
                  (() => {
                    ...
                    return (
                      <>
                        <a
                          href={smsHref}
                          className="md:hidden text-[#615a6a] text-base md:text-xl leading-7 tracking-[-0.4px] hover:text-[#433459] transition-colors group block"
                        >
                        ...
                        <a
                          ...
                          className="hidden md:block text-[#615a6a] text-base md:text-xl leading-7 tracking-[-0.4px] hover:text-[#433459] transition-colors group"
                        >
                          <SlideText>{info.phone}</SlideText>
                        </a>
                      </>
              ...
              <div className="grid grid-cols-2 gap-x-5 gap-y-3">
                {hours.map((s, i) => (
                  <div key={i} className="flex flex-col gap-1">
                    <p className="text-[#958ca2] text-base md:text-xl leading-7 tracking-[-0.4px]">
                      {s.day}
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-[#615a6a] text-sm md:text-xl leading-7 tracking-[-0.4px] whitespace-nowrap">
                        {s.openTime}
                      </span>
